  ...
  return (
    <div className="bg-[#091222] pt-14 mt-[51px] lg:mt-0">
      <div className="bg-[#1c2d44] flex flex-row items-center gap-2 py-2 px-6 lg:p-6">
        <GiSwordAltar className="text-3xl text-white" />{" "}
        <p className="text-lg xl:text-3xl text-white font-bold">Other Games</p>
      </div>
      <div className="p-4">
        <TopSlider />
        ...
        <div>
          <div className="flex flex-row items-center gap-1 mb-4">
            <img
              src={otherGamesImg}
              className="w-10 h-10"
              alt="Virtual Sport games image"
            />
            <h1 className="text-lg font-bold text-white">Other Games</h1>
          </div>

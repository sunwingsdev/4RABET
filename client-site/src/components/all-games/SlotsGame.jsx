...
import slotsGamesImg from "../../assets/menu/6.png";
...
const SlotsGame = () => {
  ...
  useEffect(() => {
    ...
    if (swiperRef4.current && swiperRef4.current.swiper) {
      swiperRef4.current.swiper.navigation.update();
    }
  }, []);
  const slotsGames = [
  ...
  return (
    <div className="w-full lg:pr-16 2xl:pr-0 bg-gradient-to-b from-[#0e192a] to-[#091222]">
      ...
      <div>
        <Swiper
          ref={swiperRef4} // Attach ref to Swiper
          breakpoints={{
            640: {

...
const LocalGames = () => {
  ...
  useEffect(() => {
    ...
    if (swiperRef6.current && swiperRef6.current.swiper) {
      swiperRef6.current.swiper.navigation.update();
    }
  }, []);
    ...
    <div className="w-full lg:pr-16 2xl:pr-0 bg-gradient-to-b from-[#0e192a] to-[#091222]">
      ...
      <div className="flex flex-row items-center justify-between  py-4">
        <div className="flex flex-row items-center gap-1">
          ...
          />
          <h1 className="text-lg font-bold text-white">Local Games</h1>
        </div>
        <div className="flex flex-row items-center gap-2">
          <div className="px-4 py-1 bg-[#152436] rounded-md">
            <p className="text-sm text-slate-400">76 Games</p>
          </div>
          {/* Custom Swiper Navigation */}
          <div className="flex flex-row items-center gap-2">
            <div className="local-prev bg-[#152436] w-8 h-8 rounded-md flex items-center justify-center cursor-pointer">
              <IoIosArrowBack className="text-slate-400 text-xl" />
            </div>
            <div className="local-next bg-[#152436] w-8 h-8 rounded-md flex items-center justify-center cursor-pointer">
      ...
      <div>
        <Swiper
          ref={swiperRef6} // Attach ref to Swiper
          breakpoints={{
            320: {

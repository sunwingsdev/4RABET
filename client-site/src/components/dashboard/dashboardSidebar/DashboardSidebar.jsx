...
const DashboardSidebar = ({ open, setOpen }) => {
  ...
  return (
    ...
    >
      {/* Start Top collapse */}
      <div className={`bg-[#213450] py-3 ${!open && "py-5"}`}>
      ...
      {/* End Top collapse */}
      {/* Start Menu bar */}
      <div className="bg-[#172437] overflow-y-auto pb-20 text-sm text-white font-semibold h-full scrollbar-hide">
        <Link to={"/"}>
          <div
            className={`px-4 py-3 flex items-center gap-2 border-b border-gray-700 duration-300 hover:bg-[#213450] hover:border-l-4 hover:border-l-slate-400 ${
              !open && "justify-center"
            }`}
          >
        ...
        {/* Bonuses Menu */}
        <div
          className="menu-item border-b border-gray-700 hover:bg-[#213450] hover:border-l-4 hover:border-l-slate-400 duration-300"
